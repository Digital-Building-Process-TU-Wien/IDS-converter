...
def create_ids_files(separated_excel_data, ifc_version, data_dict, output_path, excel_name, sheet_name):
    created_files = []
    for key in separated_excel_data.keys():
        ...
        create_ids_specifications(my_ids, sep_data['specs'], ifc_version)
